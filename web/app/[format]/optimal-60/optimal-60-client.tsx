...
function MobileArchetypeDrawer({
  archetypes,
  selectedSlug,
  onSelect,
  format,
  ...
  return (
    <>
      ...
      <button
        ...
        className="w-full flex items-center justify-between gap-3 px-4 py-3 rounded-md border bg-surface-800 border-surface-600 hover:border-surface-500 transition-all"
      >
        {selected ? (
    ...
    <div className="space-y-8">
      ...
      <div className="lg:flex lg:gap-6">
        ...
        <div className="flex-1 min-w-0 space-y-6">
          {/* Selected archetype header + navigation link */}
          {selected && (
            <div className="space-y-4">
              <div className="flex items-center gap-3">
                <SpriteRow filenames={selected.sprite_filenames ?? []} size={28} />
