...
ARCHETYPE_ANCHOR_CARDS: dict[str, dict[str, str] | str] = {
    ...
    "Mega Kangaskhan ex": {
        "_default": "Mega Kangaskhan ex",
        "Latias ex": "Mega Kangaskhan Latias",
        "Teal Mask Ogerpon ex": "Mega Kangaskhan Ogerpon",
    },
    "Mega Lucario ex": {
    ...
    "Ceruledge ex": {
        "_default": "Ceruledge ex",
        "Solrock": "Ceruledge Solrock",
    },
    "Barbaracle": "Barbaracle Okidogi",
    "Mega Diancie ex": {
        "_default": "Mega Diancie ex",
        "Dusknoir": "Mega Diancie Dusknoir",
        "Mega Slowbro ex": "Mega Diancie Mega Slowbro",
    },
    "Jellicent ex": "Jellicent ex",
    "Cornerstone Mask Ogerpon ex": "Cornerstone Ogerpon",
    "Teal Mask Ogerpon ex": {
        "_default": "Teal Mask Ogerpon ex",
        "Hydrapple ex": "Hydrapple Ogerpon",
    },
    "Slowking": "Slowking",
    "Hop's Zacian ex": "Hop's Zacian ex",
    "Mega Sharpedo ex": "Mega Sharpedo ex",
    "Mega Lopunny ex": "Mega Lopunny ex",
    "Mega Yanmega ex": "Mega Yanmega ex",
    ...
    "Mega Dragalge ex": "Mega Dragalge ex",
    "Mega Clefable ex": "Mega Clefable ex",
    "Mega Meganium ex": "Mega Meganium ex",
    "Ethan's Typhlosion": "Ethan's Typhlosion",
    "Genesect ex": {
        "_default": "Genesect ex",
    ...
    "Flygon ex": "Flygon ex",
    "Cinccino ex": "Cinccino ex",
    "Gourgeist ex": "Gourgeist ex",
    "Farigiraf ex": "Farigiraf ex",
    "Hydreigon ex": "Hydreigon ex",
